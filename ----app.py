...
def get_all_kupovni_tecajevi_for_date(date_str):
    """
    Dohvaća SVE kupovne tečajeve za zadani datum (VMT_VRSTA_TECAJA = 'RED').
    ...
    try:
        ...
        print(f"❌ Greška pri dohvaćanju tečajeva: {e}")
        return {}
...
def generate_xml(valto_nbr, start_date, end_date):
    ...
    try:
        ...
        while current_date <= end_date:
            ...
            # OPTIMIZACIJA: Dohvati SVE tečajeve za ovaj datum ODJEDNOM
            tecajevi_dict = get_all_kupovni_tecajevi_for_date(d_datum)
            print(f"  ✓ Tečajevi: {len(tecajevi_dict)} valuta")
